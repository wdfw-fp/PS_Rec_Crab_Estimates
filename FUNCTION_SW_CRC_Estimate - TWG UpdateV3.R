...
#############   
  ...
  dates=paste0("Seas_Areas_",Season,"_V3.xlsx")
  current.directory2<-paste0(getwd(),"/CRC Data/CRC Estimate Function Inputs/",Season,"/")
...
###### Create Table 6: Summary table of estimate
  ...
  pounds.estiamte.PS=Table5.output[12,6]
  ...
  colnames(Table6.output) <- c("Coastal Crabs Reported", "Puget Sound Crabs Reported","Bias Correction", "CRC Response Rate",
                        "PS Bias Corrected Rec Crabs","PS Bias Corrected Rec Pounds")
...
#########Export as table############
  ...
  Output.directory=paste0(current.directory4,paste0("/",Year,"_",Season,"_CRC_Tables_18_V2",".xlsx"))
...
prop.25C=0.18 #Proportion of catch in Marine Area 9 that occurs in 25C

#Define the CRC file name (Example: Catch Data Summer 2022.xlsx)
data.name=paste0(Season,"_",Year,"_Catch_Data.xlsx")
